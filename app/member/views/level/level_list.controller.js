...
(function() {
  ...
  angular
    .module('app.member')
    .controller('LevelListController', LevelListController);

  LevelListController.$inject = ['$scope', 'levels', '_Table'];

  function LevelListController($scope, levels, _Table) {
    var vm = this;
    vm.levels = levels;
    activate();
    ...
    function activate() {
      vm.tableParams = _Table.getTable(levels);
    }
  }
