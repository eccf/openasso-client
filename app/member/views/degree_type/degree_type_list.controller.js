...
(function() {
  ...
  angular
    .module('app.member')
    .controller('DegreeTypeListController', DegreeTypeListController);

  DegreeTypeListController.$inject = ['$scope', 'degreeTypes', '_Table'];

  function DegreeTypeListController($scope, degreeTypes, _Table) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getTable(degreeTypes);
    }
  }
