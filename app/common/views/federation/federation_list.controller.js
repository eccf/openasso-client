...
(function() {
  ...
  angular
    .module('app.common')
    .controller('FederationListController', FederationListController);

  FederationListController.$inject = ['$scope', 'federations', '_Table'];

  function FederationListController($scope, federations, _Table) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getTable(federations);
    }
  }
