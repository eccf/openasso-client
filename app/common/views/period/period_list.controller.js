...
(function() {
  ...
  angular
    .module('app.common')
    .controller('PeriodListController', PeriodListController);

  PeriodListController.$inject = ['$scope', 'periods', '_Table'];

  function PeriodListController($scope, periods, _Table) {
    var vm = this;
    vm.periods = periods;
    activate();
    ...
    function activate() {
      vm.tableParams = _Table.getTable(periods);
    }
  }
