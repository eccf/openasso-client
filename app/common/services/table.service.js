...
(function() {
  ...
  angular
      .module('app.common')
      .factory('_Table', _Table);

  _Table.$inject = ['$filter', 'NgTableParams'];

  function _Table($filter, NgTableParams) {
    return {
      ...
      getOrderTable: function(data, sorting){
        return new NgTableParams({
          page: 1, // show first page
          count: 20, // count per page
          sorting: sorting
      ...
      updateDataset: function(tableParams, dataset) {
