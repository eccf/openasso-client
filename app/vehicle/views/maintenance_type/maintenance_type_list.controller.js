...
(function () {
  ...
  angular
    .module('app.vehicle')
    .controller('MaintenanceTypeListController', MaintenanceTypeListController);

  MaintenanceTypeListController.$inject = ['$scope', 'maintenanceTypes', '_Table'];

  function MaintenanceTypeListController($scope, maintenanceTypes, _Table) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getTable(maintenanceTypes);
    }
  }
