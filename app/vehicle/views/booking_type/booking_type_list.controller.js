...
(function () {
  ...
  angular
    .module('app.vehicle')
    .controller('BookingTypeListController', BookingTypeListController);

  BookingTypeListController.$inject = ['$scope', 'bookingTypes', '_Table'];

  function BookingTypeListController($scope, bookingTypes, _Table) {
    var vm = this;
    vm.bookingTypes = bookingTypes;
    activate();

    /////////////////////

    function activate() {
      vm.tableParams = _Table.getTable(bookingTypes);
    }
  }
})();
