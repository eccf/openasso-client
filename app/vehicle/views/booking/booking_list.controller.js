...
(function () {
  ...
  BookingListController.$inject = ['$scope', 'bookings', 'currentPeriod', '_Table', '_Alert'];

  function BookingListController($scope, bookings, currentPeriod, _Table, _Alert) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getOrderTable(bookings, {
        startDate: 'desc'
      });
      initAlerts();
    }
