...
(function() {
  ...
  VehicleListController.$inject = ['$scope', 'vehicles', '_Table', '_Cache', '$timeout'];

  function VehicleListController($scope, vehicles, _Table, _Cache, $timeout) {
    var vm = this;
    activate();
    ...
    function activate() {
      vm.vehicleTableParams = _Table.getTable(vehicles);
    }
  }
