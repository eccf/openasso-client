...
(function() {
  ...
  angular
    .module('app.bike')
    .controller('BikeSizeListController', BikeSizeListController);

  BikeSizeListController.$inject = ['$scope', 'bikeSizes', '_Table'];

  function BikeSizeListController($scope, bikeSizes, _Table) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getTable(bikeSizes);
    }
  }
