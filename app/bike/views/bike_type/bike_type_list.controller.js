...
(function() {
  ...
  angular
    .module('app.bike')
    .controller('BikeTypeListController', BikeTypeListController);

  BikeTypeListController.$inject = ['$scope', 'bikeTypes', '_Table'];

  function BikeTypeListController($scope, bikeTypes, _Table) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getTable(bikeTypes);
    }
  }
