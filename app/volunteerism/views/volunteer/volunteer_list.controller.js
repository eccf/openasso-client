...
(function () {
  ...
  VolunteerListController.$inject = ['$scope', 'volunteers', 'currentPeriod', '_Table', '_Alert'];

  function VolunteerListController($scope, volunteers, currentPeriod, _Table, _Alert) {
    var vm = this;
    ...
    function activate() {
      vm.tableParams = _Table.getOrderTable(volunteers, {
        lastname: 'asc'
      });
      initAlerts();
    }
